  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
        <div className="relative flex shrink-0 h-48 md:h-28 lg:40 xl:h-48 w-full md:w-48 lg:w-64 xl:w-80 rounded-xl bg-slate-800 overflow-hidden">
          <img
        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
          ...
          <div className="hidden md:flex items-center">
            <div className="flex item-start mr-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex text-sm font-semibold text-white/[0.7] truncate overflow-hidden">
                ...
                <span className="flex text-[15px] leading-none font-bold text-white/[0.7] realtive top-[-10px] mx-1">
                  .
                </span>
